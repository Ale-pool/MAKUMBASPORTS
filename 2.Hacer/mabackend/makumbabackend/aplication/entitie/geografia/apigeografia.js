...
const { CorePais } = require('../../../core/entitie/pais/corepais'); 

const { ModelDepartamento } = require('../../../domain/entitie/departamento/modeldepartamento'); 
const { CoreDepartamento } = require('../../../core/entitie/departamento/coredepartamento'); 

const { ModelCiudad } = require('../../../domain/entitie/ciudad/modelciudad'); 
const { CoreCiudad } = require('../../../core/entitie/ciudad/coreciudad'); 
